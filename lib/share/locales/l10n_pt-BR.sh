...
label_andistro_internal_error_select_file="Erro interno ao localizar o arquivo selecionado."
...
label_andistro_bakup="Backup do Debian"
label_andistro_backup_desc="Tem certeza que deseja fazer backup do Debian?\nCaso confirme, a próxima será para definir a senha. Não existe a opção de voltar, somente de fazer o backup."
label_andistro_backup_password="Digite uma senha forte para criptografar o backup:\n\nRecomedado que seja contenha números, letra maiuscula, minuscula e simbolos (@#!$%&*)."
label_andistro_backup_password_empty="Senha vazia. Backup cancelado."
label_andistro_backup_starting="Iniciando backup do Debian..."
label_andistro_backup_compacting="Fazendo backup: compactando sistema Debian"
label_andistro_backup_encrypting="Criptografando backup com GPG (AES256)..."
label_andistro_backup_verifying="Verificando arquivo gerado..."
label_andistro_backup_success="Backup concluído com sucesso."
label_andistro_backup_error="Erro ao criar backup."
label_andistro_no_valid_backup="Nenhum backup válido encontrado (checksum ou arquitetura não compatíveis)."
label_andistro_select_backup_to_restore="Selecione o backup para restaurar:\n(Apenas arquivos com checksum válido e mesma arquitetura)"
label_andistro_searching_backups="Aguarde, estamos procurando os arquivos de backup..."
label_andistro_restore_import="Restaurar ou Importar Debian"
label_andistro_restore="Restaurar backup"
label_andistro_restore_password="Digite a senha para restaurar o backup selecionado"
label_andistro_preparing_backup="Preparando e verificando backup..."
label_andistro_decrypting_backup="Descriptografando backup..."
label_andistro_restore_failed="Falha na restauração.\n\nErro ao extrair o backup.\nVerifique se o arquivo está íntegro."
label_andistro_restore_success="Restauração concluída com sucesso."
label_andistro_restore_invalid_content="Erro ao restaurar o backup (conteúdo incompleto ou inválido)."
label_andistro_import_proot_distro="Importar do proot-distro"
label_andistro_restore_password_empty="Senha vazia. Restauração cancelada."

label_andistro_install_apps_desc="Antes de prosseguir, escolha como instalar os aplicativos necessários:"
label_andistro_install_apps_choose="Escolha um dos aplicativos, clique em instalar. Depois retorne ao Termux"
label_andistro_install_apps_playtore="Pela Play Store"
label_andistro_install_apps_here="Por aqui mesmo"
...
# Informativos
label_step_slow="Esta etapa pode ser demorada."
